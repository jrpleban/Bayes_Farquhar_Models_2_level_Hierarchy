...
source("CaCc_Jm_model_H.R") ### Bayesian Modelw/ Temp Dependency & farQ limitation

#### Set up for rjags #########
parameters = c("Vcmax", "Rd","gammaS","phiJ", "thetaJ", "Jmax","Kc", "Ko",
                "mu.Vcmax", "mu.Rd","mu.gammaS","mu.phiJ", "mu.thetaJ", "mu.Jmax",
                "tau.Vcmax", "tau.Rd","tau.gammaS","tau.phiJ", "tau.thetaJ", "tau.Jmax",
                "tau")
...
datalist1<-list(N=length(A[[1]]), NID=length(unique(IDdat[[1]])), An=A[[1]], Ca=CP[[1]], g=g[[1]],  Q=Q[[1]], O=O[[1]], ID=IDdat[[1]], Kref=298.15, R=0.008314, Tref=25) #301
datalist2<-list(N=length(A[[2]]), NID=length(unique(IDdat[[2]])), An=A[[2]], Ca=CP[[2]],  g=g[[2]],  Q=Q[[2]], O=O[[2]], ID=IDdat[[2]], Kref=298.15, R=0.008314, Tref=25) #46
datalist3<-list(N=length(A[[3]]), NID=length(unique(IDdat[[3]])), An=A[[3]], Ca=CP[[3]], g=g[[3]],  Q=Q[[3]], O=O[[3]], ID=IDdat[[3]], Kref=298.15, R=0.008314, Tref=25) #bro
datalist4<-list(N=length(A[[4]]), NID=length(unique(IDdat[[4]])), An=A[[4]], Ca=CP[[4]],  g=g[[4]],  Q=Q[[4]], O=O[[4]], ID=IDdat[[4]], Kref=298.15, R=0.008314, Tref=25)  #cab
datalist5<-list(N=length(A[[5]]), NID=length(unique(IDdat[[5]])), An=A[[5]], Ca=CP[[5]],  g=g[[5]], Q=Q[[5]], O=O[[5]], ID=IDdat[[5]], Kref=298.15, R=0.008314, Tref=25)  #oil
datalist6<-list(N=length(A[[6]]), NID=length(unique(IDdat[[6]])), An=A[[6]], Ca=CP[[6]],  g=g[[6]],  Q=Q[[6]], O=O[[6]], ID=IDdat[[6]], Kref=298.15, R=0.008314, Tref=25) #tur
#################################
##################################
##### Impliment model in JAGS ####
#################################
source("CaCc_Jm_model_H.R") ### Bayesian Modelw/ no Temp Dependency, No Gm and chl flo to describe farQ light limitation
...
####### Plot results #####
#plot(mcmc_samples1)
mcmcChain_r301_4 = as.matrix( mcmc_samples1)
chainLength = NROW(mcmcChain_r301_4)
# Convert precision (tau) to SD###
sigma =1  / sqrt( mcmcChain_r301_4[, "tau" ] )
mcmcChain_r301_4 = as.data.frame(cbind( mcmcChain_r301_4, sigma ))
...
variable.names=parameters,
n.iter=nPerChain , thin=thinSteps )
mcmcChain_r46_4 = as.matrix( mcmc_samples2)
# Convert precision (tau) to SD###
sigma =1  / sqrt( mcmcChain_r46_4[, "tau" ] )
mcmcChain_r46_4 = as.data.frame(cbind( mcmcChain_r46_4, sigma ))
...
variable.names=parameters,
n.iter=nPerChain , thin=thinSteps )
mcmcChain_bro_4 = as.matrix( mcmc_samples3)
# Convert precision (tau) to SD###
sigma = 1  / sqrt( mcmcChain_bro_4[, "tau" ] )
mcmcChain_bro_4 = as.data.frame(cbind( mcmcChain_bro_4, sigma ))
...
variable.names=parameters,
n.iter=nPerChain , thin=thinSteps )
mcmcChain_cab_4 = as.matrix( mcmc_samples4)
# Convert precision (tau) to SD###
sigma = 1  / sqrt( mcmcChain_cab_4[, "tau" ] )
mcmcChain_cab_4 = as.data.frame(cbind( mcmcChain_cab_4, sigma ))
...
variable.names=parameters,
n.iter=nPerChain , thin=thinSteps )
mcmcChain_oil_4 = as.matrix( mcmc_samples5)
# Convert precision (tau) to SD###
sigma = 1  / sqrt( mcmcChain_oil_4[, "tau" ] )
mcmcChain_oil_4 = as.data.frame(cbind( mcmcChain_oil_4, sigma ))
...
variable.names=parameters,
n.iter=nPerChain , thin=thinSteps )
mcmcChain_tur_4 = as.matrix( mcmc_samples6)
# Convert precision (tau) to SD###
sigma = 1  / sqrt( mcmcChain_tur_4[, "tau" ] )
mcmcChain_tur_4 = as.data.frame(cbind( mcmcChain_tur_4, sigma ))
...
write.table(mcmcChain_r301_4,"mcmcChain_r301_4", sep="\t", col.name=TRUE)
write.table(mcmcChain_r46_4,"mcmcChain_r46_4", sep="\t", col.name=TRUE)
write.table(mcmcChain_bro_4,"mcmcChain_bro_4", sep="\t", col.name=TRUE)
write.table(mcmcChain_cab_4,"mcmcChain_cab_4", sep="\t", col.name=TRUE)
write.table(mcmcChain_oil_4,"mcmcChain_oil_4", sep="\t", col.name=TRUE)
write.table(mcmcChain_tur_4,"mcmcChain_tur_4", sep="\t", col.name=TRUE)
#########################################################################
...
common_cols <- colnames(mcmcChain_oil_4)
mcmcChain_r301_4<-subset(mcmcChain_r301_4, select = common_cols)
mcmcChain_r46_4<-subset(mcmcChain_r46_4, select = common_cols)
mcmcChain_bro_4<-subset(mcmcChain_bro_4, select = common_cols)
mcmcChain_cab_4<-subset(mcmcChain_cab_4, select = common_cols)
mcmcChain_tur_4<-subset(mcmcChain_tur_4, select = common_cols)
#############################################


#############################################

EstPars1<-apply(mcmcChain_r301_4, 2, median)
EstPars2<-apply(mcmcChain_r46_4, 2, median)
EstPars3<-apply(mcmcChain_bro_4, 2, median)
EstPars4<-apply(mcmcChain_cab_4, 2, median)
EstPars5<-apply(mcmcChain_oil_4, 2, median)
EstPars6<-apply(mcmcChain_tur_4, 2, median)
...
dic_r301_4<-c(sum(dic1$deviance), sum(dic1$penalty),sum(dic1$deviance, dic1$penalty),
...
dic_r46_4<-c(sum(dic1$deviance), sum(dic1$penalty),sum(dic1$deviance, dic1$penalty),
sum(dic1a$deviance), sum(dic1a$penalty), sum(dic1a$deviance, dic1a$penalty))

dic1 <- dic.samples(model3, DICsteps, "pD")
dic1a <- dic.samples(model3, DICsteps, "popt")
dic_bro_4<-c(sum(dic1$deviance), sum(dic1$penalty),sum(dic1$deviance, dic1$penalty),
sum(dic1a$deviance), sum(dic1a$penalty), sum(dic1a$deviance, dic1a$penalty))

dic1 <- dic.samples(model4, DICsteps, "pD")
dic1a <- dic.samples(model4, DICsteps, "popt")
dic_cab_4<-c(sum(dic1$deviance), sum(dic1$penalty),sum(dic1$deviance, dic1$penalty),
sum(dic1a$deviance), sum(dic1a$penalty), sum(dic1a$deviance, dic1a$penalty))

dic1 <- dic.samples(model5, DICsteps, "pD")
dic1a <- dic.samples(model5, DICsteps, "popt")
dic_oil_4<-c(sum(dic1$deviance), sum(dic1$penalty),sum(dic1$deviance, dic1$penalty),
sum(dic1a$deviance), sum(dic1a$penalty), sum(dic1a$deviance, dic1a$penalty))

dic1 <- dic.samples(model6, DICsteps, "pD")
dic1a <- dic.samples(model6, DICsteps, "popt")
dic_tur_4<-c(sum(dic1$deviance), sum(dic1$penalty),sum(dic1$deviance, dic1$penalty),
sum(dic1a$deviance), sum(dic1a$penalty), sum(dic1a$deviance, dic1a$penalty))


dics<-rbind(dic_r301_4, dic_r46_4, dic_bro_4, dic_cab_4, dic_oil_4,dic_tur_4)
colnames(dics)<-c("pD_dev", "pD_pen", "pD_DIC", "popt_dev", "popt_pen", "popt_DIC")



modelname<-rep("CaCc_Jm",6)
...
write.table(ParEstFull,"ParEstFull_model_4", sep="\t", col.name=TRUE ,row.names = F)
...
pdf("~/Documents/ACiP4/Trace_plots/density_r301_4.pdf",
colormodel='cmyk' ,width=6.25, height=(80))
ggs_density(ggs(mcmc_samples1))
dev.off()

pdf("~/Documents/ACiP4/Trace_plots/density_46_4.pdf",
colormodel='cmyk',width=6.25, height=(80))
ggs_density(ggs(mcmc_samples2))
dev.off()

pdf("~/Documents/ACiP4/Trace_plots/density_bro_4.pdf", colormodel='cmyk',width=6.25, height=(80))
ggs_density(ggs(mcmc_samples3))
dev.off()

pdf("~/Documents/ACiP4/Trace_plots/density_cab_4.pdf", colormodel='cmyk',width=6.25, height=(80))
ggs_density(ggs(mcmc_samples4))
dev.off()

pdf("~/Documents/ACiP4/Trace_plots/density_oil_4.pdf", colormodel='cmyk',width=6.25, height=(80))
ggs_density(ggs(mcmc_samples5))
dev.off()

pdf("~/Documents/ACiP4/Trace_plots/density_tur_4.pdf", colormodel='cmyk',width=6.25, height=(80))
...
pdf("~/Documents/ACiP4/Trace_plots/cor_r301_4.pdf",
colormodel='cmyk',width=10, height=(10))
ggs_crosscorrelation(ggs(mcmc_samples1))
dev.off()

pdf("~/Documents/ACiP4/Trace_plots/cor_46_4.pdf", colormodel='cmyk',,width=10, height=(10))
ggs_crosscorrelation(ggs(mcmc_samples2))
dev.off()

pdf("~/Documents/ACiP4/Trace_plots/cor_bro_4.pdf", colormodel='cmyk',,width=10, height=(10))
ggs_crosscorrelation(ggs(mcmc_samples3))
dev.off()

pdf("~/Documents/ACiP4/Trace_plots/cor_cab_4.pdf", colormodel='cmyk',,width=10, height=(10))
ggs_crosscorrelation(ggs(mcmc_samples4))
dev.off()

pdf("~/Documents/ACiP4/Trace_plots/cor_oil_4.pdf", colormodel='cmyk',,width=10, height=(10))
ggs_crosscorrelation(ggs(mcmc_samples5))
dev.off()

pdf("~/Documents/ACiP4/Trace_plots/cor_tur_4.pdf", colormodel='cmyk',width=10, height=(10))
...
pdf("~/Documents/ACiP4/Trace_plots/Rhat_r301_4.pdf",
colormodel='cmyk',width=6.25, height=(20))
ggs_Rhat(ggs(mcmc_samples1))
dev.off()

pdf("~/Documents/ACiP4/Trace_plots/Rhat_46_4.pdf",
colormodel='cmyk',width=6.25, height=(20))
ggs_Rhat(ggs(mcmc_samples2))
dev.off()

pdf("~/Documents/ACiP4/Trace_plots/Rhat_bro_4.pdf", colormodel='cmyk',width=6.25, height=(20))
ggs_Rhat(ggs(mcmc_samples3))
dev.off()

pdf("~/Documents/ACiP4/Trace_plots/Rhat_cab_4.pdf", colormodel='cmyk',width=6.25, height=(20))
ggs_Rhat(ggs(mcmc_samples4))
dev.off()

pdf("~/Documents/ACiP4/Trace_plots/Rhat_oil_4.pdf", colormodel='cmyk',width=6.25, height=(20))
ggs_Rhat(ggs(mcmc_samples5))
dev.off()

pdf("~/Documents/ACiP4/Trace_plots/Rhat_tur_4.pdf", colormodel='cmyk',width=6.25, height=(20))
